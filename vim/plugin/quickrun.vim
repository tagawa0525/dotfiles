...
augroup plugin-quickrun
  ...
  autocmd Filetype c          call s:set_quickrun_command('function __rungcc__() { gcc $1 -o ${1\%.*}.exe && ./${1\%.*}.exe; } && __rungcc__')
  autocmd Filetype objc       call s:set_quickrun_command('function __rungcc__() { gcc $1 -o ${1\%.*}.exe && ./${1\%.*}.exe; } && __rungcc__')
  autocmd Filetype cpp        call s:set_quickrun_command('function __rungcc__() { g++ $1 -o ${1\%.*}.exe && ./${1\%.*}.exe; } && __rungcc__')
  "autocmd Filetype c          call s:set_quickrun_command('function __rake__() { rake ${1\%.*}; } && __rake__')
  "autocmd Filetype objc       call s:set_quickrun_command('function __rake__() { rake ${1\%.*}; } && __rake__')
  "autocmd Filetype cpp        call s:set_quickrun_command('function __rake__() { rake ${1\%.*}; } && __rake__')
  ...
  autocmd Filetype bash       call s:set_quickrun_command('bash')
  autocmd Filetype csh        call s:set_quickrun_command('csh')
  autocmd Filetype zsh        call s:set_quickrun_command('zsh')
